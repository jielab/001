...
### 关于蛋白质结构预测
>- 下载 [千人基因组深度测序VCF文件](https://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1000G_2504_high_coverage/working/20220422_3202_phased_SNV_INDEL_SV/), 下载[参考基因组fasta文件](https://ftp.ensembl.org/pub/current_fasta/homo_sapiens/dna) 然后samtools faidx, 下载[gff3文件](https://ftp.ensembl.org/pub/current_gff3/homo_sapiens/), 下载[vcf2prot软件](https://github.com/ikmb/vcf2prot)
