...
下载[gtf文件](https://ftp.ensembl.org/pub/current_gtf/homo_sapiens/), 下载[gff3文件](https://ftp.ensembl.org/pub/current_gff3/homo_sapiens/), 下载[vcf2prot软件](https://github.com/ikmb/vcf2prot)
