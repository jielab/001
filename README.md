...
## #4.1 确认结果可靠，从[GWAS catalog](https://www.ebi.ac.uk/gwas) 寻找已经发表的该表型的GWAS文章，比较 BETA。
...
## #4.2 注释 GWAS信号，使用 [Pheweb](https://github.com/statgen/pheweb) 流水线作业。本组的所有 GWAS数据的 pheweb 网站是 http://www.jielab.org 


### 也可以使用 [PLINK](https://www.cog-genomics.org/plink/1.9/) 人工操作。请点击左边菜单中的 Report postprocess 中的 3个命令（--annotate, --clump, --gene-report）
