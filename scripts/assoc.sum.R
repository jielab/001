pacman::p_load(data.table, tidyverse, stringi, TwoSampleMR, MendelianRandomization, mrMed)
...
# 基于MR的mediation
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
dir.X = '/work/sph-huangj/data/gwas/?/clean'
dir.Y = '/work/sph-huangj/data/gwas/?/clean'
dir.M = '/work/sph-huangj/data/gwas/?/clean'
Xs = '?'
Ys = '?' 
...
#	writeLines(paste('\n\n-->Run:', Y))
	...
	for (X in Xs) { # 🍷
		...
		if(nrow(dat.X.iv) ==0) {print(paste("SKIP:", X,"NA",Y, "X no IV !!")); next}
