...
dat <- dat0 %>% filter(ethnic_cat=="White") %>% rename(IID=eid) 
	...
	mutate(
		FID = IID,
		a01 = ifelse(blood_group=="OO", 0, ifelse(blood_group=="AO", 1, NA)),
		b01 = ifelse(blood_group=="OO", 0, ifelse(blood_group=="BO", 1, NA)),
		a12 = ifelse(blood_group=="AO", 0, ifelse(blood_group=="AA", 1, NA)),
		b12 = ifelse(blood_group=="BO", 0, ifelse(blood_group=="BB", 1, NA)),
		a012 = ifelse(blood_group=="OO", 0, ifelse(blood_group=="AO", 1, ifelse(blood_group=="AA", 2, NA))), 
		b012 = ifelse(blood_group=="OO", 0, ifelse(blood_group=="BO", 1, ifelse(blood_group=="BB", 2, NA))), 	
		...
		bald1a2 = ifelse(bald==2,1, ifelse(bald1ab=="a",0,NA)),
		bald1b2 = ifelse(bald==2,1, ifelse(bald1ab=="b",0,NA)),
		bald1a3 = ifelse(bald==3,1, ifelse(bald1ab=="a",0,NA)),
		bald1b3 = ifelse(bald==3,1, ifelse(bald1ab=="b",0,NA)),
		bald1a4 = ifelse(bald==4,1, ifelse(bald1ab=="a",0,NA)),
		bald1b4 = ifelse(bald==4,1, ifelse(bald1ab=="b",0,NA)),
