...
dir=/work/sph-huangj
gcta --bfile data/mhc --cojo-file data/height.100.txt --cojo-slct --cojo-p 5e-08 --out height
module load python/anaconda3/2020.7 # HPC上需要这个
source activate heels
awk '{print chr snp 0 pos a1 a2}' > height.bim
python $dir/software/heels/run_HEELS.py --output_fp jie --sumstats_fp pheno.txt \
	--ld_fp ukb_332k_chr22_LD.npz --ld_snp_fp height \
